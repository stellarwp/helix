...
interface Repository_Interface extends Read_Interface, Update_Interface {
	 ...
	 */
	public function set_formatter( Formatter_Interface $formatter );
	 ...
	 *
	 * @return $this
	 * @throws Usage_Error If one of the callback methods does
	 *                                        not add any WHERE clause.
	 *
	 * @see Repository::where_clause()
	 * @see Query_Filters::where()
	 */
	 ...
	 *
	 * @throws Usage_Error If the comparison operator or the relation are not valid.
	 */
	 ...
	 *
	 * @return Interface The repository instance, for chaining.
	 * @throws Usage_Error If trying to set the query after a fetching operation is done.
	 */
	 ...
	 *
	 * @return Interface $this The repository instance.
	 */
